...
function setDescriptionForMovesList(move,currentMove, lastMoveColIndex,lastMoveRowIndex, historicMovesIndexes, description){
    if (move === currentMove) {
        fillhistoricMovesIndexes(lastMoveColIndex,lastMoveRowIndex, historicMovesIndexes, move);
